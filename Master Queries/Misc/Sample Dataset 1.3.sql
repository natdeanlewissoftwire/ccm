...
-- WHERE distinct_acbs_cleaned_names_linked_to_active_facilities.cleaned_name LIKE '%BAYERISCHE LANDESBANK%'

ORDER BY distinct_acbs_cleaned_names_linked_to_active_facilities.cleaned_name

-- so far: group by cleaned name groups, this has all the info EXCEPT non-active acbs records that fuzzy match

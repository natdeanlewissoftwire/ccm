...
-- , sf_legacy_address.customer_address_street, sf_legacy_address.customer_address_city, sf_legacy_address.customer_address_postcode, sf_legacy_address.customer_address_county_state, sf_legacy_address.customer_address_country
FROM acbs_customers
    ...
    -- ON sf_legacy_customers.ods_key = sf_legacy_address.ods_key
